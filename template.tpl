...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Parse.ly Conversion Tracking",
  ...
  "description": "Fires a Parse.ly conversion event.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "defaultValue": "select conversion type",
    "help": "Choose the category of the conversion event. Read more at docs.parse.ly/conversions/#h-type"
  },
  {
    "type": "TEXT",
...
Created on 02/02/2023, 14:43:54
